...
export const REEL_STRIPS = [
    // Left Reel (Based on reference)
    [
        SYMBOLS.GRAPE, SYMBOLS.SEVEN, SYMBOLS.REPLAY, SYMBOLS.GRAPE, SYMBOLS.CHERRY,
        SYMBOLS.GRAPE, SYMBOLS.REPLAY, SYMBOLS.CLOWN, SYMBOLS.BAR, SYMBOLS.GRAPE,
        SYMBOLS.BELL, SYMBOLS.REPLAY, SYMBOLS.CLOWN, SYMBOLS.GRAPE, SYMBOLS.BAR,
        SYMBOLS.REPLAY, SYMBOLS.GRAPE, SYMBOLS.CHERRY, SYMBOLS.GRAPE, SYMBOLS.REPLAY,
        SYMBOLS.BELL
    ],
    // Center Reel
    [
        SYMBOLS.REPLAY, SYMBOLS.SEVEN, SYMBOLS.GRAPE, SYMBOLS.CHERRY, SYMBOLS.REPLAY,
        SYMBOLS.BAR, SYMBOLS.GRAPE, SYMBOLS.CHERRY, SYMBOLS.REPLAY, SYMBOLS.REPLAY,
        SYMBOLS.BELL, SYMBOLS.GRAPE, SYMBOLS.CHERRY, SYMBOLS.REPLAY, SYMBOLS.SEVEN,
        SYMBOLS.GRAPE, SYMBOLS.CHERRY, SYMBOLS.REPLAY, SYMBOLS.BELL, SYMBOLS.GRAPE,
        SYMBOLS.CHERRY
    ],
    // Right Reel
    [
        SYMBOLS.BELL, SYMBOLS.SEVEN, SYMBOLS.BAR, SYMBOLS.REPLAY, SYMBOLS.GRAPE,
        SYMBOLS.BELL, SYMBOLS.CLOWN, SYMBOLS.REPLAY, SYMBOLS.GRAPE, SYMBOLS.BELL,
        SYMBOLS.CLOWN, SYMBOLS.REPLAY, SYMBOLS.GRAPE, SYMBOLS.BELL, SYMBOLS.CLOWN,
        SYMBOLS.REPLAY, SYMBOLS.GRAPE, SYMBOLS.BELL, SYMBOLS.CLOWN, SYMBOLS.REPLAY,
        SYMBOLS.GRAPE
    ]
];
